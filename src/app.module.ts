...
@Module({
  imports: [TypeOrmModule.forRoot({
      ...
      database: 'spb',
      entities: [event_source, event_type, event, scenario, step_type, scenario_step, session_type, session, event_rule, session_log, param_type, session_param, setting_type, setting_value, dict_type, action_type, provider, dict, audio, dict_value, speaker, speaker_audio, dict_synonym, action, scenario_type, command],
      synchronize: true,
     }), 
